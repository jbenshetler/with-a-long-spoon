...
The outing is planned in **Pace's kitchen**: he proposes meeting her people; Vee offers **Randi** first (the two-on-one he can't afford; he never declines, only adds); *"What about Cassie?"*; Vee hems (Cassie won't come if it's small and Randi-shaped — the `dear` own-friends thought resurfacing in reverse, the connector over the launderer); his name-drops (Meg, "Kayla, the one with the—?") land the swoon, and the **group catches fire as Vee's own idea**. Chili's remembered (the event, never the diagnosis) → *"you pick the place"* → **"Let me handle it"** (deed, not word; name and location handed over off-page). Every escalation his, every decision hers. Full machine: craft note.
