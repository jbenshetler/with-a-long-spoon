...
Pace's friend — the one outside-the-house bond the novel shows him keeping. **Lesbian, not bisexual** (load-bearing; see "Why She Sees Pace Clearly"). ~20, a psych undergrad of mediocre ability — render the mediocrity without contempt; she is not stupid, she is ordinary at school and entirely uninterested in being graded on it.

She is **not a second Cassandra.** Two confidantes see clearly for *structurally opposite* reasons (below); Sheri is a true variant, not a mirror. Keep her perception **Pace-specific** — a glancing radar, not a diagnostic instrument. If she starts reading the whole configuration the way Cassie does, the asymmetry flattens and both characters lose their edge.

---

## Look

Tiny and slender, ~5'0" — set **deliberately against Pace** (strongly built, average height). Render her as **kinetic and capable, never fragile:** she's small because she's always *moving* — running, cycling, kung fu, dancing — **not** any eating issue. The smallness is engine, not frailty.

Small round face, slightly sallow skin, long permed-and-highlighted hair. At the CW bar: **too much makeup, awkwardly applied** — and this is **the third makeup position** in the novel's three-women appearance grammar:

- **Cassie** — doesn't try (no makeup, eschewed not lacked).
- **Randi** — labor invisible (the work that doesn't show).
- **Sheri** — visible effort, imperfect result, **no shame.** She tried, it's a little wrong, she does not care that it's a little wrong.

A **working/country idiom**, not the campus polished-sorority register. (Don't stage the three-position contrast on the page; it lives in the rendering. Same don't-write-it-every-time discipline as the Cassie/Randi managed-vs-unmanaged contrast.)

---

## Temper

She has one — and it is her **threat-response**, not a mood. Residue of the betrayal (see Backstory), pointed at **anything fake, cruel, or conditional.** **The warmth is in the fierceness, not in being pleasant.** She is not warm the way a hostess is warm; she is warm the way someone is warm who has decided, at cost, who is worth defending. The held temper aimed *outward* at whoever hurt Pace is the engine of her last appearance (below).
...
This is **structurally opposite from Cassie's immunity:**

- **Cassie** is outside the **appearance economy** — no skin in being-looked-at, so she reads Randi for *operation* instead of being caught in the beam.
- **Sheri** is outside **Pace's economy** — his masculine register can't land, so she sees the friend instead of the man.

**Two clarities, opposite mechanisms** — a real variant. Cassie's clarity is about *Randi/the configuration*; Sheri's is about *Pace himself.* Do not let them converge.
...
She has **almost no access to why Pace is the way he is** — the temperament, the scar, the started-college-at-15 history are all closed to her. Her entire holding of his backstory is **one sentence**, offered once and never asked past: *it went bad with his daddy; he hasn't been home since he was sixteen.* (**Diction:** *daddy*, not *father* — Sheri's Southern/country register; Vee, from Ohio, says *father*. Match the word to the speaker.) She surfaces it exactly once, to Vee in {{Another Round}} — flat, unpadded, closed with the boundary (*"Two years he's been my friend, and that is every word of it I've got"*) — and the ration is itself testimony: two years of friendship and she never pried. Beyond that sentence, all she knows is that he is **different in a way that makes him the kind of kind that doesn't blow away.**
...
**Glancing. NOT a second Cassandra.** One encounter, one verdict: ***"She's a lot."*** Done. Her disowning-honed radar for **conditional people** pings once — she knows the type that loves on terms — and she **does not diagnose** the way Cassie does. Pace deflects; the reader files it next to Cassie's warning, and the two warnings are different instruments (Cassie's structural/sustained, Sheri's a single ping from a different sensor).

Keep her perception **Pace-specific.** The radar is for *people who withdraw when the terms change* — which is her wound's exact shape — not for the configuration's mechanics.

---

## Last Appearance

After the reckoning: ***"Give me ten minutes."*** No questions. That's the scene.

It lands **because the loyalty is earned:** the held temper finally aimed **outward** at whoever hurt him, the one surviving bond **paying back the debt of having survived.** She doesn't need the story; she needs the name and ten minutes. The fierceness that is her warmth, discharged on his behalf. Do not soften it, do not explain it, do not have Pace accept or decline on the page — the line is the scene.
