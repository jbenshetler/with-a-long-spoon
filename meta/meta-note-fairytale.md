...
Three **bodies-in-sync** beats — ski, dance, sex — each genuinely good, each reaching nothing. The scene is built to make that pattern land. Randi is **fully hoping** the whole way up; the *nothing* is discovered only at the mirror. Suspicion kills it: everything is lovely and unironically romantic on first read (Hallmark dialed to 11); the deadness is legible only in the mirror and on reread. If the reader feels it upstream, the mirror stops being a trapdoor.
...
6. **The gala: dinner + ballroom.** His white tie is perfectly altered (a man can't rent a real one) — money + preparation + belonging, silent. Old-money native (cotillion, the right forks at twelve) beside Randi-who-*learned*-to-pass: the same wound in another key — the performance flawless and hollow — resonance only, never named. She is fully hoping, open, a little disarmed.
   - **The lead-follow beat.** He leads; her trained body follows perfectly; an expert lead makes it effortless. For one beat it reads as the shape of being handled, surrendered, taken — and it isn't. He leads her *body*; Pace leads her to the floor and sees *her*. Same surrender-shape, opposite content. **Bodies-in-sync #2.**

7. **The sleigh ride back to his hotel.** Apex of the conventional — "it doesn't get better than this." Its *job*: plant the close's core image as literal winter fact — warm only where they touch, the cold everywhere else; fur, his hand, muffled bells, the town lights below. Pre-echoes the bed. *Precise and quiet, not gushing; the cold reads as literal winter on first pass, never ominous.*
...
- **Location.** Fairytale → **Gstaad**, established **in-scene** (Randi's POV at the resort). On Vee's side the *destination* is known in advance — Randi told her before break she was skiing in Gstaad for Christmas (best-friend baseline; below the threshold of what must be rendered), so Vee's close-third can name *"dresses from Gstaad"* (`my-friend-randi.md:21`). What the sparse break texts withheld was the *story*, not the place (*"two lines and a chalet,"* `my-friend-randi.md:101`). *(Author ruling 2026-08-13.)* (The old *"Gesso mid-November"* pointer was wrong twice over: `{{Gesso}}` is a **spring** SATC scene following `{{Still Life}}` (~late Jan, *after* NYE), and no off-grid beat exists.)
