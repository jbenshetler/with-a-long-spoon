...
- **LOW craft-pace "Pool"** — the "brace it" premise was wrong (no chapter titled "Pool"); resolved by author to `{{We Find Out}}, {{Safely Held}}, {{The Deep End}}` (`meta-craft-pace.md:46`). ✅
