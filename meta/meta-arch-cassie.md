...
**Her plainness is the unstated source of her clear sight.** No skin in the appearance economy — and (author-knowledge) none in the sexual economy either — so she reads Randi for *operation* instead of being caught in the beam. Everyone else is inside one of Randi's beams; Cassie is the one standing outside all of them, which is exactly why she sees the mechanism.
...
**The chair line, relabeled.** The meet-cute's *"He looked at her like she was a chair"* is **not a warning about Pace.** It is Cassie registering the *engineered / too-clean* quality of the encounter (an **anomaly report**), with her conscious suspicion attaching to **Randi** (the hand under the table, the staging that doesn't add up) — not to Pace's character. She is watching the visible operator and missing that there are two engines. *(Supersedes the earlier "warning about Pace" label in `meta-plan-chronology.md` continuity flag 5 — update owed; see Continuity Flags below.)*
...
Standard double with Vee — **bunk beds (Vee took the top without being asked)**, two desks, a bathroom shared through a connecting door with the room next door. A partial scholarship covers Vee's housing premium. Cassie's side may be neater; the contrast is part of the friendship.
...
2. **Chair-line relabel owed in `meta-plan-chronology.md`.** Continuity flag 5 there calls the meet-cute "chair" line "a warning about Pace." Per the Knower Discipline above, it is an **engineered-anomaly report attached to Randi**, not a Pace-warning. Update flag 5. **Not yet applied.**
