...
- The disowning **story surfaces on the page exactly once**, here, in **Sheri's own dry register**. The bare *fact* of estrangement is planted earlier — `Cheeseburgers` (~late Dec), where Sheri mentions she isn't in contact with her family (*"me not talking to my people,"* never the cause) — so this telling lands as **payoff, not first mention**. (See `meta-arch-sheri.md` → plant-vs-payload.)
