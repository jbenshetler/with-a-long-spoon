...
19. **The Permission Rule — creation + the slip.** Full mechanism in `meta-arch-vivienne.md` → The Permission Rule. To do: (a) **establish on the page, ~mid-spring** — Pace gives the rule (tell-before; not to thoughts of him without telling). The November bathroom suppression (First Swat Debrief) *predates* it: there the not-relieving is self-imposed shame; once the rule lands the same restraint becomes obedience, a deeper alteration. Don't write the rule as retroactively in force. (b) **The slip vignette (later in spring)** — Vee takes SATC-track relief under the *"the lunch undid me"* description and mid-way it is *his* face: she has crossed into the forbidden wanting under a permitted label. Does she owe the telling? She decides she didn't quite notice. Guilt as not-looking, not crisis; cf. the tell-after failure-confession.
