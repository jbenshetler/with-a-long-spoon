...
*Early fall · ~Sun Sep 29 · same day as the hike* · Unwritten · Cassandra track · [detail](meta-condensed-cassie-before.md)
Vee tells Cassie about the hike and shirt — clean baseline of her feeling for Pace, said aloud before Randi ever reshapes the material. Load-bearing: the reader needs this once, so the later contamination has something to contaminate. Pairs with Cassie — After.
...
*~early August* · Architecture complete, prose not drafted · `threesome-reveal.md` · [detail](meta-condensed-threesome-reveal.md)
...
*Immediately after the Threesome* · Architecture complete, prose not drafted · `threesome-reveal.md` · [detail](meta-condensed-ending-sequence.md)
...
8. **Randi has no surname — and needs none.** Full given names (Miranda, Vivienne, Cassandra, Peter) are reserved instruments; no surnames in-world.

9. **Chi Latte — CANONIZED.** Greek-heavy coffee shop on Draper Street, yellow-and-white, high window tables. Rendered *"Chi Latte"* in dialogue, *Χ ΛΑΤΕ* on the sign. Distinct from the Wilson Street coffee shop (Meet-Cute venue).

10. **Latent-variable plant — PLACED.** Seeded as ambient end-of-class preview in the Chi Latte diptych. Later stats mirrors (continuous-vs-discrete at Nipple Clamps, etc.) do not re-explain the term.

11. **Phase 2 reorder — RESOLVED.** True reading order now reflected in the Running Order above. Silk-naming relocates from the Porch Scene into the Hiking Rainstorm (now drafted, `hiking-rainstorm.md`). Required draft edit in `the-fitting.md`: revise the line locating the silk-naming "at sunrise three mornings ago… through the porch glass" → to the trail/hike. Porch Scene freed for the cracker-and-meal / displaced *I love you* beat.
    - **Filename:** prose file is `hiking-rainstorm.md`; condensed is `meta-condensed-hiking-rainstorm.md` (note: not `the-`). Detail links updated.
    - **Color framing (corrected this session, supersedes older docs).** The hike names **russet / brick-red only** — the magazine shade. The Fitting does **not** impose a unilateral color-match: Pace *offers* a variant slightly off the russet, honoring the want beneath it (to look beautiful); Vee consents and comes to see it suits her better. **No "poured wine" phrasing** anywhere in the hike. **Open edits:** (a) `meta-rules.md` ~line 178 ("burgundy, not russet… he went deeper and warmer, matched her coloring") → reframe as offer-honoring-the-want, not Pace-chose-for-her; (b) `meta-condensed-the-fitting.md` Plants section references the hike color as *"like poured wine"* → change to *russet, like a brick*; (c) `the-fitting.md` silk-naming reference points to the trail/summit lunch with the russet phrasing.

12. **First Night motive — RESOLVED.** Motivated by the Fitting's deferred tension, not the CW Dance. Do not write as reassurance-seeking or loss-driven.
...
14. **CW-Dance Debrief venue — RESOLVED: Randi's single.** Deliberately NOT the velvet brunch. Vee's unannounced Friday-morning arrival catches the room unstaged; the counsel and the first shoe loan run inside the one space her world never sees — only Vee ever crosses that threshold (Bible, her-room canon). Rendered in Vee's POV; the containers rule is untouched.
...
18. **Back from Thanksgiving — RESOLVED (expansion drafted).** The vignette now carries the full design in prose: cropped induction photo forces the telling, the legibility monologue (the parts that fit / what she withheld / the sewing she couldn't say), and the dodge relocated to "what is he to you." Table stays off-page; setting is the athletic-dorm cafeteria. Guard for the Christmas Fight, still live: the retelling loads *external legibility* (Pace vs. her father's frame), distinct from the fight's *internal definition* (monogamy / what are we), so the fight's sympathy for Pace is untouched. Field/credential ("math PhD candidate") and the dance both confirmed against canon.
