...
- **Continuity:** Berkeley conference is distinct from Top Drawer's Chicago (two November conferences — fall cluster); dress worn bare (per {{Peekaboo}} slit logic); heels canon from {{Shoe Shopping}} (Vee's own, dear, four-inch dark strap); toe/finger polish = frosted plum (matched at {{Shoe Shopping}}); {{Leave No Trace}} timing recast to November ("Still weeks off, come November").
