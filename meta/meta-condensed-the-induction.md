...
*VIGNETTE · Draft complete (`scenes/the-induction.md`) · ~mid-to-late November, a weekday afternoon, the ceremony hall · Vee POV (Cassie present) · psychologically intense, low-explicit · short*
...
- **Continuity:** Berkeley conference is distinct from Top Drawer's Chicago (two November conferences — fall cluster); dress worn bare (per {{Peekaboo}} slit logic); heels canon from {{Sorority}} (Vee's own, dear, four-inch dark straps); toe/finger polish = frosted plum (matched at {{Sorority}}); {{Leave No Trace}} timing recast to November ("Still weeks off, come November").
