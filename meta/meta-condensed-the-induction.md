...
The burgundy induction dress — made by Pace for exactly this (named on the hike, built at the Fitting, finished for the Dress Pickup) — has its public debut, and the scene turns the event into Vee's first *chosen* public display. It is the ownership beat: liberation as owning chosen shame, not shamelessness. Warm and proud on the surface; the cold lives only in the arrangement, on reread.
...
The daydream (Dress Pickup coda: the room turning for her) is subverted — the real room is dull and kind, no one turns on their own. So she makes them: the long second step, the leg given to the hip, the murmur through the crowd, the composed face, the scroll (rolled paper, ribbon), the room knowing and no one able to say it out loud. The heat as the body agreeing. She does not once make herself small.
