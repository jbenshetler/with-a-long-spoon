...
5. **{{Stats — Simpson's Paradox}}.** *Drafted: `scenes/stats-simpsons-paradox.md`.* The old standalone "Vee shows Cassie the dress" folds into the statistics lecture, where Vee sits between both girls (Cassie | Vee | Randi) and the finished dress is **old news to both** (the fitting tellings — {{Turned Up}} and {{How It's Done}}) — so neither re-reveals it. The fork is how each meets the transformed Vee: **Cassie watches Vee, not the dress** (*"Was it a good night?" / "Yes. Oh, yes."*), warm and done in three lines; **Randi is already past the dress onto its deployment**, drawing out the shoe-gap and binding it with a favor (*"How's Saturday"*) — which **launches {{Shoe Shopping}} (item 6).** The gown stays in its garment bag at the dorm, **shown to no one** (the bag-zipped-for-Cassie / out-for-Randi motif). Warm and **unshadowed**; the professor's **Simpson's-paradox** drone scores it — the aggregate that reads as love and reverses only once the hidden grouping is seen. Deliberate contrast with the showing-to-Randi register at shoe-shopping.
