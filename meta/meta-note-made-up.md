...
## Placement and the EVENT

The chronology keeps **[EVENT] Halloween** (Sat Oct 31, calendar landmark) — EVENTs are calendar markers, never prose. This vignette is a separate entry landing on that evening, inside the {{We Find Out}} weekend (Vee wakes at the house Saturday; canon multi-day stay). Origin of the beat: the open question of whether Pace ever sees the induction dress and its heels *together* — he was in Berkeley for the ceremony and got only the photo.

## The two-costume mechanism

- The bathroom door (there is one, with a door; Pace gives privacy) makes each reveal a **door opening** — the show's stagecraft. Two reveals, no more.
- *Costumes*, not outfits — Halloween's own word in her mouth, the permission slip. The road gets no trick-or-treaters; the holiday is present **only as the word**. No decorations, no candy, no costume-party apparatus.
- Costume two is not a departure from costume one but its **interior** — outside-of-the-dress, then inside-of-it. Don't frame it as a striptease; the dress is hung, the door closes and opens. No disrobing on camera.

## The line, and the canon under it

Her line at reveal two: ***"And this is what I had on under it."*** This is literal canon — {{The Induction}}: *"Under the burgundy, nothing at all"*; the going-bare was **Vee's own discovery** in his mirror at {{Peekaboo}} (the slit showed the edge of anything), *not* a Pace instruction. **Guard:** do not invent a prior instruction from Pace ("wear what you'd wear under it" — checked 2026-08-06, no such line exists; the fitting's only undergarment line is *"The bra too... It'll lie to me"* at {{A Round}}). If a fitting echo is wanted, it's her correction of her own fitting (she stood in bra and panties then, wrongly) — a year of knowing later.

## Choice, informed — the We Find Out link
...
## Dark-on-reread (do not point at it)

On the costume holiday she dresses up as **the woman the two of them built** — his dress, Randi's steering onto the heels — and neither maker is named while she does it. Costume two tells the reader what walked through the induction ceremony. First read: the sexiest, warmest show-and-tell. No sinister note anywhere on the page.
