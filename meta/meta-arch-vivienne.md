...
Installed at the cabin (~late Feb; see `meta-note-cabin-weekend.md`); on the page operating in `scenes/vee-on-the-bench.md`; cf. the bathroom-trip progression in `meta-plan-chronology.md` and the SATC relief channel in `meta-plan-satc-tracks.md`.
