...
`scenes/peekaboo.md`, and `scenes/vee-on-the-bench.md` — treat as fixed. `[PLAN]` = established in
...
the woodshop); **The fitting plays here.** On the page (`scenes/peekaboo.md`):
