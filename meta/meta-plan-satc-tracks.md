...
**The spring record so far:** {{We Find Out}} debrief — stops (prohibitive). {{Covering}}, Tue Jan 19 — completes in the stall, through the kind eyes, filed as about Pace; counts it her **third** restroom (the practice room counted against herself, deliberately — she catastrophizes herself in memory and is kind to others; do not "fix" the arithmetic); **promises the mirror she'll control herself next time**. {{A Clean Plate}}, Thu Jan 21 — **no trip** (ruling 2026-08-23, supersedes 2026-08-22's kept-promise repeat): wound up by her own telling, deflated by the non-agreement, **undischarged** — the charge rides home. {{The Reach}}, same night — her room (entry rebuild pending; see the chronology). Then the post-{{On Her Floor}} retreat.

**Unspent thread (do not silently drop):** {{Covering}}'s mirror promise was never staged or tested — Thursday kept it trivially. Decide at the next wound-up SATC whether it pays (a *failed* promise deep in spring, near the *show me* era, lands far harder than a kept one) or quietly expires.
