...
- **The neck ({{Covering}} → ratified {{A Clean Plate}}, Jan 19/21; author ruling 2026-08-22):** after the mouth kiss, inside the hug — Randi's giggled *you made my neck wet* callback, the awkward point, and Vee's unthinking *"I'm sorry for making a mess"* kiss where Randi points. Randi **flinches** (the control-slip, first instance — once, never again). Thursday, Randi turns her head and offers the neck; Vee kisses it because it feels right; no flinch. Opens the spring's partings fresh; becomes part of how they part, never named.
...
2. **Restaurant restroom, during/after — middle.** The orgasm moves into the venue; she excuses herself, gets herself off in the bathroom, returns to the table still warm. Space-gap-only; deniability thinning; she comes back into Randi's company carrying what she just did. (The first restroom trip — the {{We Find Out}} debrief — is a precursor: she acts but stops herself short of completion; the first *completed* restroom orgasm lands at {{Covering}}, Tue Jan 19 — **early, before rung 3's {{The Reach}}; author ruling 2026-08-22: the ladder is deliberately non-monotonic** — completion, then Thursday's kept-promise brake, then the post-{{On Her Floor}} pullback: a sawtooth, not a staircase.)
2a. **At the table, Randi watching — late middle (committed 2026-08-03; recovers a prior-session plan that never landed).** The rung between the restroom and the chair: Vee brings herself off **at the brunch table itself**, under the table's cover, **with Randi watching** — directed/permitted by Randi (the edging instructions' natural next stake: no longer *bring me the proof after*, but *do it here*), the public face held. Collapses the space-gap while keeping the table's social shell; the chair-rung then strips even that cover. Leans **before** the Sheer Dress Brunch's nipple tweak (~May, late spring) — author lean, not a hard constraint. **Host scene TBD** (an unplaced late-spring brunch or format break); scene assignment pending.
...
| 2 | stall, **stops** | imagined, **prohibitive** — the kind eyes stop her | nothing; the brake holds *({{We Find Out}}; repeats at {{A Clean Plate}} — now as {{Covering}}'s promise kept)* |
| 3 | her room, same night | **escaped** | proximity — she needs distance and a Pace label *({{The Reach}})* |
| 4 | stall, **completes** | imagined, **survivable** — she goes through it | the brake. Randi in mind, still filed as about Pace *(lands at {{Covering}}, Tue Jan 19 — early, before rung 3, by ruling 2026-08-22; her interior count "third restroom" includes the practice room — she catastrophizes herself in memory; deliberate, do not "fix")* |
