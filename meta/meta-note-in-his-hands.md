...
*Companion craft note. Holds the intent kept off the page — the sole-channel seed, the Sheri plant, the guards. The register is the fall's warm, low-explicit baseline before spring turns transgressive.*
...
The gentle fall counterweight: warm, tender, unshadowed, low-explicit. It carries two forward-seeds that need a November home — the **photo** (sole-channel) and **Sheri** (the absorber) — inside a scene whose surface is only a couple in bed, worn out and easy with each other. Nothing kinky; the comfort-motif (Pace taking comfort at her breast) is the established tenderness, not a beat to explain.
...
- **Sole-channel motif** — the photo → the cabin's "he becomes her eyes" → the bench → the threesome kiss (`meta-note-threesome-reveal.md`).
- **Sheri as the absorber → the found hair** — naming her here arms the spring found-hair beat (`meta-note-the-found-hair.md`): the safe woman Vee reaches for when a trace of a woman turns up in his house, so the outward question never forms. Plant here, spend in spring.

## Guards

- Shadowless on the surface — no sinister note; the family shadow is *his* wound (warm-sad), not con-shadow.
- Body before mind; low-explicit; the comfort-motif stays wordless (don't explain the taking-comfort).
- Sheri reported only; family cause vaulted; the photo played light, never solemn.
