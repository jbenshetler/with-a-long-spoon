...
> **Contrast engine for later:** Randi's first goodbye-kiss (How It's Done) arrives pre-coded as deniable and lands *bigger* than Pace's careful first — the reader clocks the inversion before Vee can name it.
