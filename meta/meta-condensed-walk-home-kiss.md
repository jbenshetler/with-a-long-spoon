...
> **Contrast engine for later:** Randi's first goodbye-kiss (Vee Tells Randi About the Fitting Brunch) arrives pre-coded as deniable and lands *bigger* than Pace's careful first — the reader clocks the inversion before Vee can name it.
