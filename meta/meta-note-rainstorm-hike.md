...
- **Sits before the Fitting and before the first night.** Reading order: …The Smoothie Shop → **The Hiking Rainstorm** → Vee Tells Cassie — Hike → Fitting → Vee Tells Cassie About the Fitting → How It's Done → … → First Night Together.
