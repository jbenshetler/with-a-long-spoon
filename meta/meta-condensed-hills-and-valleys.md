...
*Compaction of the drafted scene (`scenes/hills-and-valleys.md`); surface only — the unrendered craft/subtext lives in `meta-note-hills-and-valleys.md`. ~Sat Oct 24 morning, between the CW-Dance blowup (Thu) and that evening's reconciliation. Pace POV.*
...
- *"What happened to the pale sorority chick?"* / *"Randi. That's not finished."* She files it.
