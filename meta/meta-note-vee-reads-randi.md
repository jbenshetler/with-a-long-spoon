# Note — Vee Reads Randi's Makeup

*Author's note. Guides how Vee perceives and internally registers Randi's appearance.*
*For Randi's makeup details: `meta-craft-randi.md` → Physical Description.*
*For Vee's perceptual register generally: `meta-craft-vivienne.md`.*
...
The foundation she might not be able to articulate at all. She'd just notice that the woman's skin looked almost unreal — not cakey, not shiny, just impossibly even. She might think fleetingly that she must have great skin, before realizing no, it was something applied, something that cost more than she'd spend in a month on everything combined.

What she'd feel overall is not quite envy but something more complicated — a recognition that this woman inhabited her own face the way you inhabit a very expensive, perfectly fitted room. Everything in its place. Nothing accidental.
...
**First encounter vs. ongoing.** The full perceptual sequence belongs at or near first encounter — the meet-cute or the early coffees, when Vee is still reading Randi as a surface before the warmth takes over. In later scenes, the awareness is residual: a half-second where Vee's eye goes to the lipline and notes, again, the sharpness. Not catalogued again in full. The first-encounter reading does the work for the whole novel.
...
**Placement candidate:** the meet-cute or an early one-on-one. **Update (Together in Class / Chi Latte reconciliation):** the first one-on-one is now the **Chi Latte diptych (`together-in-class.md`)**, drafted with only a *light aspirational* read — at the high table Vee registers Randi as rank/aspiration (the cream, the bound ponytail, the citrus-cold scent, the upward want), **not** the full face-catalogue. **Decision: the full lipstick/cat-eye/foundation sequence is saved for later** — not folded into Together in Class / Chi Latte. It remains available for a later close-proximity scene (a meet-cute revision, an SATC lunch, the shoe-shopping or dressing-room beats). The campus walk established Vee's surface as ungradeable by Randi's grammar; the reverse perception belongs in a scene where they're close enough for Vee to study the face — placement deferred, sequence preserved here intact.
