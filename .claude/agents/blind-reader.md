...
- **Motifs & images:** recurring images, objects, gestures, or phrases I noticed —
  ...
  appearance from my carry-forward ledger). A first sighting counts too; mark it as
  first vs. repeat.
...
- **Pace — within the chapter:** where it dragged or rushed; did the scene earn its
  length.
- **Pace — chapter to chapter:** momentum against the last chapter and the run so
